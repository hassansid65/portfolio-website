...
export const TestimonialSlider = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-[650px] md:min-h-[600px] overflow-hidden bg-transparent text-white p-8 md:p-12",
        className
      )}
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full">
        ...
        <div className="md:col-span-3 flex flex-col justify-between order-2 md:order-1">
          <div className="flex flex-row md:flex-col justify-between md:justify-start space-x-4 md:space-x-0 md:space-y-4">
            ...
            <h2 className="text-sm font-medium tracking-widest uppercase [writing-mode:vertical-rl] md:rotate-180 hidden md:block text-neutral-500">
              Reviews
            </h2>
          </div>
            ...
            {thumbnailReviews.map((review) => {
              ...
              return (
                <button
                  ...
                  className="overflow-hidden rounded-md w-16 h-20 md:w-20 md:h-24 opacity-70 hover:opacity-100 transition-opacity duration-300 focus:outline-none focus:ring-2 focus:ring-[#00E5FF] focus:ring-offset-2 focus:ring-offset-black"
        ...
        <div className="md:col-span-4 relative h-80 min-h-[400px] md:min-h-[500px] order-1 md:order-2">
          <AnimatePresence initial={false} custom={direction}>
            <motion.img
              ...
              className="absolute inset-0 w-full h-full object-cover rounded-lg shadow-2xl shadow-black/50"
            />
          </AnimatePresence>
        </div>
        ...
        <div className="md:col-span-5 flex flex-col justify-between md:pl-8 order-3 md:order-3">
          ...
          <div className="relative overflow-hidden pt-4 md:pt-24 min-h-[200px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                <p className="text-sm font-medium text-[#00E5FF] uppercase tracking-wider">
          ...
          {/* Navigation Buttons */}
          <div className="flex items-center space-x-2 mt-8 md:mt-2">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-12 h-12 border-white/20 bg-black/50 hover:bg-white/10 text-white"
              onClick={handlePrev}
            ...
            <Button
              variant="default"
              size="icon"
              className="rounded-full w-12 h-12 bg-white text-black hover:bg-neutral-200"
              onClick={handleNext}
